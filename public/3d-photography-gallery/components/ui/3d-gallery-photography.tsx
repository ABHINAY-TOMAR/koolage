'use client';
// FIX: Changed type-only import to a full import to allow TypeScript to recognize @react-three/fiber's custom JSX elements.
...
// FIX: Refactor ImagePlane to be an arrow function component with explicit props
// This helps TypeScript properly recognize it as a React component and handle the 'key' prop correctly.
  ...
  return (
    <>
      {planesData.current.map((plane, i) => {
        ...
        // FIX: Cast texture.image to a type with width and height properties to resolve TypeScript error.
